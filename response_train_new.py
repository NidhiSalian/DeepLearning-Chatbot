...
output = Dense(300, activation='relu', name='activation')(after_dp2)

model = Model(inputs=sequence, outputs=output)
#optimizers.Adam(lr=0.0001, beta_1=0.6, beta_2=0.799, epsilon=1e-08, decay=0.05)
...
for iteration in range(1, no_of_iterations):
	...
	for diversity in [ 1.3, 1.6, 1.9]:
		...
		for i in range(200):
			...
			preds = model.predict(x_seed, verbose=0)
